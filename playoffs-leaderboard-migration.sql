-- Update the leaderboard function to support 'playoffs' as an aggregate of all knockout stages
...
AS $$
  ...
  WHERE
    (p_stage IS NULL OR 
     (p_stage = 'playoffs' AND f.stage IN ('r32', 'r16', 'qf', 'sf', 'third', 'final'))
     OR (p_stage != 'playoffs' AND f.stage = p_stage))
